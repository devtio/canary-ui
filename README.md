...
This project is the UI project for [devtio/canary](https://github.com/devtio/canary)
  
## Install
- `git clone https://github.com/devtio/canary-ui.git` or `git clone git@github.com:devtio/canary-ui.git`
- `cd canary-ui`
- `yarn install`

## Running locally
- Run devtio/canary locally on port 8080
- `yarn start`
